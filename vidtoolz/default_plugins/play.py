...
def register_commands(subparser):
    ...
    play_parser.add_argument("-s", "--speed", type=float, default=1.0, help="Playback speed")
    play_parser.add_argument("-l", "--loop", type=int, default=0, help="Number of times to loop (0=infinite)")
