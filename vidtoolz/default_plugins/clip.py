...
def register_commands(subparser):
    ...
    clip_parser.add_argument("output_file", nargs="?", help="Path to the output video file (optional)")
    
    # Time arguments
    clip_parser.add_argument("-s", "--start", help="Start time (seconds or MM:SS or HH:MM:SS)")
    clip_parser.add_argument("-e", "--end", help="End time (seconds or MM:SS or HH:MM:SS)")
    clip_parser.add_argument("-d", "--duration", help="Duration to clip (seconds or MM:SS or HH:MM:SS)")
